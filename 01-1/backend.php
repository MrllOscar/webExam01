    ...
    <div id="ms">
      <div id="lf" style="float:left;">
        <div id="menuput" class="dbor">
          ...
          <a style="color:#000; font-size:13px; text-decoration:none;" href="?do=home">
            <div class="mainmu">
              網站標題管理 </div>
          </a>
        ...
        <table width="100%">
          <tbody>
            <tr>
              ...
              <td><button onclick="document.cookie='user=';location.replace('/index.php')" style="width:99%; margin-right:2px; height:50px;">管理登出</button></td>
            </tr>
          </tbody>
        </table>
      <?php
