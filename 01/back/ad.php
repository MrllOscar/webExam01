          ...
          <form method="post" action="../api/manage.php">
            <table width="100%">
              <tbody>
                ...
                <?php $rows=$Ad->all();
                foreach($rows as $row){
                  printf('<tr><td><input type="text" name="text[]" style="width:90%%" value="%s"></td>',$row['text']);
            ...
            <table style="margin-top:40px; width:70%;">
              <tbody>
                <tr>
                  <td width="200px"><input type="button" onclick="op('#cover','#cvr','../window/ad.php')" value="新增網站標題圖片"></td>
